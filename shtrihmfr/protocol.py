...
BUGS = {
    ...
    0x29: (
        'ФП',
        'Технологическая метка в накопителе отсутствует, возможно накопитель '
        'пуст',
    ),
    0x2A: (
        'ФП',
        'Фактическая емкость микросхемы накопителя не соответствует '
        'текущей версии ПО',
    ),
    # Begin Deprecation
    ...
    0x2F: (
        'ФП',
        'Не совпадает заводской номер ККМ в оперативной памяти ФП '
    ...
    0x96: ('ККТ', 'Выполните суточный отчет с гашением'),
    ...
    0xB9: (
        'ФП',
        'Сигнатура версии структуры данных в накопителе не '
        'совпадает с текущей версией ПО',
    ),
    0xBA: ('ФП', 'Структура накопителя повреждена'),
    0xBB: (
        'ФП',
        'Текущая дата+время меньше даты+времени последней записи '
        'активизации ЭКЛЗ',
    ),
    0xBC: (
        'ФП',
    ...
    0xCD: (
        'ККТ',
        'Обратитесь в ЦТО: тест целостности архива ЭКЛЗ не прошел, '
